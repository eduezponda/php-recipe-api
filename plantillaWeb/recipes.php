        ...
        <div class="row properties-box">
            ...
            <div class="item">
              <a href="recipe-details.php"
                ><img
                  ...
                  alt=""
              /></a>
              <span class="category">Query</span>
              <h6>Tiempo preparación</h6>
              <h4><a href="recipe-details.php">Titulo receta</a></h4>
              <ul>
                <li>Proteínas: <span>32</span></li>
                <li>Grasas: <span>57</span></li>
                <li>Calorías: <span>64</span></li>
              </ul>
              <div class="main-button">
                <a href="recipe-details.php">Más información: </a>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div class="item">
              ...
              <h6>$1.180.000</h6>
              <h4>
                <a href="recipe-details.php">54 New Street Florida, OR 27001</a>
              </h4>
              <ul>
              ...
              <div class="main-button">
                <a href="recipe-details.php">Schedule a visit</a>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div class="item">
              ...
              <h6>$980.000</h6>
              <h4>
                <a href="recipe-details.php">14 Mid Street Miami, OR 36450</a>
              </h4>
              <ul>
          ...
          >
            <div class="item">
              ...
              <h6>$1.520.000</h6>
              <h4>
                <a href="recipe-details.php">26 Old Street Miami, OR 12870</a>
              </h4>
              <ul>
          ...
          >
            <div class="item">
              ...
              <h6>$3.145.000</h6>
              <h4>
                <a href="recipe-details.php">34 New Street Miami, OR 24650</a>
              </h4>
              <ul>
